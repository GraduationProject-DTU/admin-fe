    ...
    <div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5" v-if="!loadingIconAction">
            <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                <button class="btn btn-primary shadow-md mr-2" @click="createCoupons">Thêm</button>
            </div>
                        ...
                        <tr class="intro-x" v-for="(item, index) in dataPage" :key="index" :value="index">
                            ...
                            <td class="table-report__action w-30">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3 text-primary" href="javascript:;" @click="updateCoupons(item._id)">
...
export default {
    ...
    methods: {
        ...
        async deleteCoupons() {
            this.loadingIconAction = true
            const res = await CouponsApi.deleteCoupons(this.idDel)
        ...
        createCoupons() {
            this.$router.push({ path: '/coupons/create' })
        },

        updateCoupons(id) {
            this.$router.push({ path: '/coupons/create', query: { id: id } })
        }
    }
}
</script>
