<template>
    <div>
        <h2 class="intro-y text-lg font-medium mt-4 mb-5">Danh sách tài khoản</h2>
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
                <button class="btn btn-primary shadow-md mr-2" @click="createUser">Thêm</button>
            </div>
            <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
                ...
                <table class="table table-report -mt-2" v-if="!loadingIconAction">
                    ...
                    <tbody>
                        <tr class="intro-x" v-for="(item, index) in listUser" :key="index" :value="index">
                            <td>{{ index + 1 }}</td>
                            ...
                            <td class="table-report__action w-30">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3 text-primary" href="javascript:;" @click="updateUser(item._id)">
...
export default {
    ...
    methods: {
        ...
        async deleteUser() {
            const res = await UserApi.deleteUser(this.idDel)
            if (res.mess !== 'Delete user successfully !') {
                Toastify({
        ...
        updateUser(id) {
            this.$router.push({ path: '/user/create', query: { id: id } })
        }
    }
}
</script>
